                ...
                <div className="container">
                    ...
                    <div className="footer-row">
                        ...
                        <div className="column column5">
                            ...
                            <ul>
                                <li>
                                    <a href="#">{footer_icon_1}</a>
                                </li>
                                <li>
                                    <a href="#">{footer_icon_2}</a>
                                </li>
                                <li>
                                    <a href="#">{footer_icon_3}</a>
                                </li>
                                <li>
                                    <a href="#">{footer_icon_4}</a>
                                </li>
                                <li>
                                    <a href="#">{footer_icon_5}</a>
                                </li>
                            </ul>
                            <a href="#"><img src={App_store} alt="" className='app_store' /></a>
                            <a href="#"><img src={Google_play} alt="" className='google_play' /></a>
                        </div>
                    </div>
