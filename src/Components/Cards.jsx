            ...
            <div className="filter-btns">
                <div className="container">
                    <div className="btn_row">
                        <a className="btn"><FilterIcon /> Filters</a>
                        <a className="btn">Open Now</a>
                        <a className="btn">Offers</a>
                        <a className="btn">Rating: 4.5+</a>
                        <a className="btn">Pet friendly</a>
                        <a className="btn">Outdoor seating</a>
                        <a className="btn">Serves Alcohol</a>
                    </div>
                </div>
            </div>
